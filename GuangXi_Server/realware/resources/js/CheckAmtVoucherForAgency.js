...
var detailFields = ["str_voucher_id", "tran_detail_id", "voucher_no", "voucher_check_no", "admdiv_code", "vou_date", 
                    ...
                    "send_flag", "checkResult", "checkReason", "back_vt_code","month","sup_dep_name","exp_func_name",
...
var detailHeader = "基层预算单位|agency_name|200,功能科目|exp_func_name|140,对账结果|check_result_desc|100,不符原因|checkReason|140,本期直接支付金额|cur_dir_pay_amt|120," +
...
function selectVtTypeState() {
	...
	Ext.getCmp('vou_Date').setVisible(false);
}
