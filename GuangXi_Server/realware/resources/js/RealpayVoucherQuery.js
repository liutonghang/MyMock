...
var comboSelect=Ext.create('Ext.data.Store',{
	fields : ['name', 'value'],
	data: [/*{
		"name" : "全部",
		"value" : ""
...
Ext.onReady(function() {
  ...
  function changeBillStore(){
	  var billType=Ext.getCmp('bill_Type').getValue();
	  if(billType==0){
		  Ext.getCmp('voucherState').bindStore(comboVoucherStatus3);
	  } else {
		  //billType==1
		  Ext.getCmp('voucherState').bindStore(comboVoucherStatus2);
	  }
