...
var fileds = ["account_id","account_name", "account_no", "bank_code", "fund_type_code",
		"fund_type_name", "admdiv_code", "create_date", "is_valid"];
...
Ext.onReady(function() {
	...
	gridPanel1.getStore().on('beforeload', function(thiz, options) {
		...
		if (admdiv == null || admdiv == "")
			return;
		beforeload(Ext.getCmp("clearAccountQuery"), options, Ext.encode(fileds));
		...
		items : [Ext.create('Ext.panel.Panel', {
			tbar : [{
						...
						items : [{
									...
									scale : 'small',
									handler : function() {
										editRealFundAccountDialog(gridPanel1);
									}
								}, {
									id : 'deleteBtn',
									text : '删除',
