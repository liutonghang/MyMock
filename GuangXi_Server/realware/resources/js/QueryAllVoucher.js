...
var fileds = ["pay_voucher_code", "vou_date", "pay_amount", "pay_date",
		...
		"voucher_status","last_ver","ori_pay_voucher_code","ori_pay_amount"]; // 数据项
...
var header = "凭证状态|voucher_status|120,凭证号|pay_voucher_code|140,凭证日期|vou_date|100,支付金额|pay_amount|100,收款人账号|payee_account_no|140,支付日期|pay_date|80"
		...
		+ "结算方式名称|set_mode_name,用途名称|pay_summary_name,支票号|checkNo,办理方式编码|fund_deal_mode_code,办理方式名称|fund_deal_mode_name,原凭证号|ori_pay_voucher_code,原金额|ori_pay_amount";
...
Ext.onReady(function() {
	...
	gridPanel1.setHeight(document.documentElement.scrollHeight - 105);
	// 根据查询条件检索数据
