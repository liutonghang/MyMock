...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/ZeroProvince.js"></script>
  ...
  <body>
	...
	var loadUrl = "<%=path%>/loadProvinceAdmdivZeroAccount.do";
	var accountTypes = ["11"];   //财政零余额
	var accountType = 11;
   </script>
  </body>
</html>
