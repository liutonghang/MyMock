...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/resources/js/AccountOfAgentPayee.js"></script>
	</head>
	<script type="text/javascript">
		...
		var loadUrl = "<%=path%>/loadAgentPayeeAccount.do";
		var accountType = "33";   //财政国库资金实有资金账户类型
   </script>
	<body></body>
</html>
