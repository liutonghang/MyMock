...
<html>
	<head>
		...
		<!-- 对应着2503、2504凭证 chengkai 2015-2-26 17:41:30 -->
       ...
       <script type="text/javascript" src="<%=path%>/resources/js/CheckAmtVoucherByMOFShanDong.js"></script>
	</head>
	<script type="text/javascript">
		...
		var loadUrl = "<%=path%>/queryCheckAmtWithMOFForShanDong.do";
