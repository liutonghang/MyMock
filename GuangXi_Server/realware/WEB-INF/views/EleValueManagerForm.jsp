...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/resources/js/EleValueManage.js"></script>
  </head>
  <script type="text/javascript">
		...
		var loadEleValueUrl = "<%=path%>/loadEleValue.do";
		var inputUrl = "<%=path%>/inputEleValue.do";
		var exportUrl = "<%=path%>/exportEleValue.do";
   </script>
  <body>
  </body>
</html>
