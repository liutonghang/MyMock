...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/resources/js/CreateAndSendClearVoucher.js"></script>
	</head>
	 <script type="text/javascript">
		...
		var loadUrl = "<%=path%>/getPayVoucherByClearId.do";
		var loadPayUrl = "<%=path%>/loadPayVouchers.do";
