...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/resources/js/QueryAllVoucher.js"></script>
	</head>
	<script type="text/javascript">
		...
		//var comboPbSetMode =  Ext.create('Ext.data.Store', {
		//	fields : ['code', 'name'],
		///	data : ${pbSetModeList}
		//});
		...
		var sendPayVoucherUrl = "<%=path%>/sendVoucher.do";
