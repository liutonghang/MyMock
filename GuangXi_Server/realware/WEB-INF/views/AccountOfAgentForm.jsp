...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/resources/js/AccountOfAgent.js"></script>
	...
	<script type="text/javascript">
		...
		var loadUrl = "<%=path%>/loadAgentAccount.do";
		var directAccType = "31";    //直接支付划款账户类型
		var accreditAccType = "32";  //授权支付划款账户类型
   </script>
	<body></body>
</html>
