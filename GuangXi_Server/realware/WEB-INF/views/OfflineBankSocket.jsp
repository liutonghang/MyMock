...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<%=path%>/resources/ux/css/GroupTabPanel.css" />
		<script type="text/javascript" src="<%=path%>/resources/js/OfflineBankSocket.js"></script>
