...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/jscostum/AccountOfInnerHangingByOfficeCard.js"></script>
	...
	<script type="text/javascript">
		...
		var loadUrl = "<%=path%>/loadOfficialsAccount.do";
		var synUrl = "<%=path%>/accountSyn.do";
		var account_type_code = "8";   //内部挂账账户类型
   </script>
	<body></body>
</html>
