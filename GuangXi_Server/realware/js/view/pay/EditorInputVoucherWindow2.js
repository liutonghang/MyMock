 ...
 * @memberOf {TypeName} 
 */
Ext.define('pb.view.pay.EditorInputVoucherWindow2', {
	extend : 'Ext.window.Window',
	alias : 'widget.editorVoucherInputWindow2',			
						...
						listeners:{
							specialkey: function (field, o) {
								if (o.getKey()==Ext.EventObject.ENTER){ 
									...
									tempController.queryPlanDetail(2);
                       			 }  
...
//							allowBlank : false,
					          ...
					          
					 {
						...
						name : 'voucherType',
						xtype : 'textfield',
						fieldLabel : '<font color=red></font>凭证种类',
						allowBlank : true, 
						listeners: {
							specialkey: function (field, o) {
								if (o.getKey()==Ext.EventObject.ENTER){     
