 ...
 * @memberOf {TypeName} 
 */
Ext.define('pb.view.pay.PayUnusualInputFormWindow', {
	extend : 'Ext.window.Window',
	alias : 'widget.payUnusualInputFormWindow', //别名
	layout : 'fit',
	modal : true,
	width : '100%',
	height : '100%',
		...
		items : [ {
			...
			items : [ {
				...
				items : [ {
					...
					bbar : Ext.PageUtil.pagingTool('pay.RefundOriVouchers')
				}, {
					xtype : 'gridpanel',
					id : 'requestpanel',
					anchor : '100% 50%',
