...
var fileds = ["pay_clear_voucher_code", "voucher_status_des", "pay_amount", "agent_account_no",
		...
		"last_ver","tips_pack_no","voucher_status_err","payDictateNo"];
//导出TBS|href1|130|exportTBS,
var header = "凭证号|pay_clear_voucher_code|130,凭证状态|voucher_status_des|100,支付交易序号|payDictateNo|100,Tips文件包号|tips_pack_no|80,金额|pay_amount|120,收款银行账号|agent_account_no|150,收款银行账户名称|agent_account_name|150,收款银行名称|agent_bank_name|150,"
...
function selectStatus(){
	...
	if(statuId == "5"||statuId == "2"||statuId == "4"||statuId == "0"||statuId == ""){
		...
		Ext.widget('window', {
			...
			items : [Ext.widget('form', {
				...
				buttons : [{
					...
					handler : function() {
							//支付交易序号
							var payDictateNo = Ext.getCmp('payDictateNo').getValue();
							//支付报文编号
