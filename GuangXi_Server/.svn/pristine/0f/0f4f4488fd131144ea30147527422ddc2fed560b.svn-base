...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=path%>/jscostum/PAPayAmountReportFormHistory.js"></script>
	</head>
	<script type="text/javascript">
		...
		var  belongOrgCode = ${session.belongOrgCode};
		var loadGrfURL = "<%=path%>/loadReportByCode.do";
		var loadDataURL="<%=path%>/loadReportData.do";
		var loadComBoAgencyZeroAccURL = "<%=path%>/loadComBoAgencyZeroAcc.do";
   </script>
	<body></body>
</html>
