 ...
 * 
 */
public class GXCCBMsgHead extends MsgHead {
	 ...
	 * @param isHasFile
	 */
	public GXCCBMsgHead(int msgLen, String tradeCode, String operator,
	 ...
	 * @param isHasFile
	 */
	public GXCCBMsgHead(int msgLen, String tradeCode, String tradeId,
