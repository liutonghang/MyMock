							...
							tbar : [{
								...
								items : [ {
											...
											handler : function() {
												...
												GridPrintDialog('undefined','undefined',loadGrfURL ,loadDataURL,"pbCollectByBankCodeAndMonth",data,100);
											}
										},{
											id : 'printByYear',
											text : '按年打印',
											...
											handler : function() {
												...
												var data="[{\"payDay\":[\"'"+payDate+"'\"]," 
															+"\"belongOrgId\":[\""+belongOrgId+"\"],"
															+"\"admdivCode\":[\""+admdivCode+"\"]}]";
												GridPrintDialog('undefined','undefined',loadGrfURL ,loadDataURL,"pbCollectByBankCodeAndYear",data,100);
											}
										}]
							}],
							items : [{
